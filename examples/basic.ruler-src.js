...
! function () {
    L.Class.Feature = L.Class.extend({
        ...
        reorderFeatures: function (t, e) {
            for (var i in e.featureList)
                if (e.featureList[i].options.name === t) {
    ...
    function () {
        L.Class.ControlFeature = L.Class.Feature.extend({
            ...
            initialize: function (t) {
                ...
                var e = this,
                    i = this.options.name,
                    o = this.disableFeature,
                    n = this.enableFeature;
                this.capString(i);
...
var Geo = {
    ...
    getGeoJson: function (e) {
        ...
        for (var o in s)
            if (s[o].properties.id === e) return s[o].index = parseInt(o), s[o];
        return null
    },
    ...
    persistGeoJson: function (e) {
        var s, o, t = [],
            i = e.options.id ? "update" : "insert",
            n = e.options.id || (new Date).getTime();
...
! function () {
    L.Class.LabelFeature = L.Class.Feature.extend({
        ...
        drawTooltip: function (t, e, i) {
            ...
            var l = this.core.options.color,
                o = this.getIconHtml(i, l);
            e.totalIcon = L.divIcon({
                ...
                total: !0,
                type: "label"
            }).addTo(e), this.drawTooltipHandlers({
                latlng: t
            }, e, i)
        },
        ...
        drawTooltipHandlers: function (t, e, i) {
            var l = this,
                o = e,
                n = i ? i : "Untitled",
                a = "ruler" === e.options.type,
                s = (this.core._map, e.options.title.split(" ")),
                r = {
                    scalar: s[0],
                    unit: s[1]
                };
            ...
            var c = {
                ...
                p = function (t) {
                    var e = l.map;
                    L.DomEvent.stop(t), d(t) && u(), t.originalEvent && L.DomUtil.hasClass(t.originalEvent.target, "close") && (e.fire("shape_delete", {
                        id: o.options.id
                    }), e.fire("shape_changed"))
                },
                u = function (t) {
                    if (l.core.selectedLayer = o, a) return void o.fireEvent("selected", c);
                    var i, s = (l.map, e),
                        r = "",
                        d = e.total._icon.children[0],
                        p = d.children,
                        u = function (t) {
    ...
    L.Class.DragFeature = L.Class.ControlFeature.extend({
            ...
            var t, n = this,
                o = function (e, o, a) {
                    if ("node" === e.options.type) {
                        ...
                        var i, r, s = n.getSegments(t),
                            l = n.core._map.latLngToContainerPoint(o.latlng);
                        for (var g in s)
                            if (i = L.LineUtil.closestPointOnSegment(l, s[g][0], s[g][1]), r = n.core._map.containerPointToLatLng(i), r.equals(o.latlng, .003)) return void (n.selectedLayer = a)
                    }
                };
        ...
        dragLayer: function (e) {
            ...
            if (this.dx = e.originalEvent.movementX, this.dy = e.originalEvent.movementY, this.selectedNode && "node" === this.selectedNode.options.type) {
                ...
                var t = this,
                    o = (new L.Transformation(this.dx, 1, this.dy, 1), this.selectedLayer);
    ...
    L.Class.NodeFeature = L.Class.ControlFeature.extend({
        ...
        renderLabel: function (t, o, e, l) {
            var i, r = e.type,
                ...
                n = this.core._map.latLngToContainerPoint(t);
            var p_latLng = this.core._map.containerPointToLatLng(n)
            if ("dot" === e.type && (a = "blue"), o) {
                var c = L.divIcon({
...
! function () {
    L.Class.RulerFeature = L.Class.LineFeature.extend({
        ...
        drawRulerLines: function (t, e) {
            if (this.latlngs.length) {
                var i, n = e ? this.latlngs.concat([e.latlng]) : this.latlngs,
                    s = 0,
                    a = 0,
                    o = !1;
                if (s = this.getStaticSum(n), this.cleanUpTmp(t), n.length > 1)
                    for (var r in n) o = n[r].equals(n[n.length - 1]), i && (a += this.displayMarkers.apply(this, [
                        [i, n[r]], !0, a, t, s, o
                    ])), i = n[r]
            }
        },
        displayMarkers: function (t, e, i, n, s, a) {
            var o, r, l, h, u, p, c, f = t[1],
                y = t[0],
                m = y.distanceTo(f) / this.UNIT_CONV,
                U = m,
                C = n.measure || this.measure,
                N = this.core._map.latLngToContainerPoint(f),
                T = this.core._map.latLngToContainerPoint(y),
                d = 1,
                g = s,
                F = !0;
        ...
        getStaticSum: function (t) {
            ...
            if (t.length)
                if (t[0].length)
                    for (var i in t) e += this.countLine(t[i]);
                else e = this.countLine(t);
            else e = this.sum;
            return e
        },
    ...
    L.Class.StyleFeature = L.Class.ControlFeature.extend({
        ...
        affectSelectedLayer: function (t) {
            ...
            i[t] = e.core.options[t], this.core.selectedLayer && (this.core.selectedLayer.eachLayer(function (n) {
                if (n.setStyle) n.setStyle(i);
                else {
                    var a = n.options.icon,
                        o = i[t],
                        s = "";
        ...
        idealTextColor: function (t) {
            var e = 105,
                i = this.getRGBComponents(t),
                n = .299 * i.R + .587 * i.G + .114 * i.B;
        ...
        buildPaintPane: function () {
            ...
            i.enable(), this.buildPaneHeader(), this.buildPaneSection("color", function () {
                ...
                t.paintDashArray.addEventListener("click", function (e) {
                    if (L.DomEvent.stop(e), L.DomUtil.hasClass(e.target, "clickable")) {
                        var i = "svg" === e.target.nodeName ? e.target : e.target.parentElement,
                            n = i.childNodes,
        ...
        buildPaneHeader: function () {
            var t = this,
                e = ['<span>Styling Options</span><i class="close">x</i>'].join("");
        ...
        buildPaneSection: function (t, e) {
            var i = this.capString(t),
                n = this["build" + i + "Section"]();
        ...
        buildColorSection: function () {
            var t = this.core.options.pallette,
                e = "",
                i = [];
        ...
        buildDashArraySection: function () {
            var t = this.core.options.dashArrayOptions,
                e = "",
                i = [],
                n = 10;
        ...
        buildOpacitySection: function () {
            var t = ["opacity", "fillOpacity", "weight"],
                e = [],
                i = 0,
                n = 0;
...
var Handlers = {
    ...
    getMouseClickHandler: function (i) {
        var t = !1;
        if (this.layer || this.initLayer(), this.isDblClick()) this.onDblClick(i);
        else {
            var e;
